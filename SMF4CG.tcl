...
pattern Plain 100 Linear {
	...
	# MF COLUMNS LOADS
	load 405103 0. -23.313 0.; 	load 405203 0. -34.969 0.; 	load 405303 0. -34.969 0.; 	load 405403 0. -23.313 0.; 
	...
	# EGF COLUMN LOADS
	load 550 0. -310.443750 0.; 	load 560 0. -310.443750 0.; 
...
puts "Seismic Weight= 3236.450 kip";
...
pattern Plain 222 Linear {
	load 405103 -0.52567 0.0 0.0
	load 404103 -0.42889 0.0 0.0
	load 403103 -0.28636 0.0 0.0
	load 402103 -0.13418 0.0 0.0
}
