...
pattern Plain 100 Linear {
	...
	# MF COLUMNS LOADS
	load 403103 0. -23.313 0.; 	load 403203 0. -34.969 0.; 	load 403303 0. -34.969 0.; 	load 403403 0. -23.313 0.; 
	load 402103 0. -28.750 0.; 	load 402203 0. -43.125 0.; 	load 402303 0. -43.125 0.; 	load 402403 0. -28.750 0.; 

	# EGF COLUMN LOADS
	load 350 0. -310.443750 0.; 	load 360 0. -310.443750 0.; 
...
puts "Seismic Weight= 1574.650 kip";
puts "Seismic Mass=  3.598 kip.sec2/in";
...
pattern Plain 222 Linear {
	load 403103 -0.61376 0.0 0.0
	load 402103 -0.43161 0.0 0.0
}
