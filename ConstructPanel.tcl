########################################################################################################
# ConstructPanel.tcl                                                                         		   #
# SubRoutine to construct a rectangular panel zone (nodes and elements)                                #
#                                                                                                      #
#                                                                                                      #
########################################################################################################
#																									   #
...
proc ConstructPanel {Axis Floor X_Axis Y_Floor E A_Panel I_Panel d_Col d_Beam transfTag} {
 ...
 set P_Elm_100XY00 [expr 4000000 + $Floor*1000 + $Axis*100];  # ID for ZeroLength Panel Element
